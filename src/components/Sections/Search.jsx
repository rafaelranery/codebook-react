...
export const Search = ({ setSearchSect }) => {
    ...
    const handleSearch = (e) => {
        e.preventDefault()
        setSearchSect(false)
        navigate(`/products?q=${searchVal.current.value}`)
    }
        ...
        <div className="mx-auto max-w-screen-xl p-2 my-5">
            <form onSubmit={(e) => handleSearch(e)} className="flex items-center">
                <div className="relative w-full">
                    ...
                    <input ref={searchVal} name="search" type="text" id="simple-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" autoComplete="off" required="" />
                </div>
