...
export const FilterBar = ({ setFilterOpen }) => {
    const {
        setBestSellerOnly,
        setInStockOnly,
        setSortBy,
                ...
                <div className="py-4 overflow-y-auto">
                    <ul className="text-slate-700 dark:text-slate-100">
                        ...
                        <li className="mt-1 mb-5">
                            ...
                            <div className="flex items-center my-1">
                                <input
                                    onChange={() => setRatings("4STARABOVE")}
                                    checked={ratings === "4STARABOVE" && true}
                                    id="rating-sort-1"
                                    type="radio"
                                    value=""
                                    name="rating-sort"
                            ...
                            <div className="flex items-center my-1">
                                <input
                                    onChange={() => setRatings("3STARABOVE")}
                                    checked={ratings === "3STARABOVE" && true}
                                    id="rating-sort-2"
                                    type="radio"
                                    value=""
                                    name="rating-sort"
                            ...
                            <div className="flex items-center my-1">
                                <input
                                    onChange={() => setRatings("2STARABOVE")}
                                    checked={ratings === "2STARABOVE" && true}
                                    id="rating-sort-3"
                                    type="radio"
                                    value=""
                                    name="rating-sort"
                            ...
                            <div className="flex items-center my-1">
                                <input
                                    onChange={() => setRatings("1STARABOVE")}
                                    checked={ratings === "1STARABOVE" && true}
                                    id="rating-sort-4"
                                    type="radio"
                                    value=""
                                    name="rating-sort"
                        ...
                        <li className="mt-1 mb-5">
                            ...
                            <div className="flex items-center my-1">
                                <input
                                    ...
                                    checked={bestSellerOnly ? true : false}
                                />
                                <label
                                    htmlFor="best-seller"
                                    className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"
                            ...
                            <div className="flex items-center my-1">
                                <input
                                    ...
                                    value=""
                                    className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                                    checked={inStockOnly ? true : false}
                                />
                                <label
